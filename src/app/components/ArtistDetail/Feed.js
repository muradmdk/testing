...
import ShareModal from '../../components/SharingModal/ShareModal';
...
function Feed() {
    ...
    return (
        <>
            ...
            <CRow>
                <CCol lg={12}>
                    <p className='font-lato fs-16 fw-700 lh-19 color-blue mb-2'>2 Hours ago</p>
                    <p className='font-lato fs-16 fw-700 lh-19 color-blue'>
