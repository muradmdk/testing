...
export default function Comment() {
  ...
  const [focusedCommentId, setFocusedCommentId] = useState(null); // To track which comment input is focused
  ...
  const toggleReplyInput = (id) => {
    setVisibleReplyInputs((prev) =>
      prev.includes(id) ? prev.filter((inputId) => inputId !== id) : [...prev, id]
    );
  };
  ...
  const addSubChildReply = (commentId, replyText, user, avatar, mentionUser) => {
    setComments((prevComments) => {
      return prevComments.map((comment) => {
  ...
  return (
    <div>
      <div className="post-search-wrapper position-relative mb-3">
        <input
          type="text"
                ...
                <div className="position-relative">
                  {comment.subChild.map((child) => (
                    <div key={child.id}>
                        ...
                        <div className="sigle-comment-box-wrapper child-comment-box mt-2">
                          ...
                          <div className="single-comment-box-desc ps-1">
                            <div className="single-comment-box-placeholder">
                              ...
                              <p className="mb-0">
                                <Link href="#" className="mention-user me-1">
                            ...
                            <div className="comment-action-wrapper">
                              ...
                              {child.user !== currentUser && (
                                <div className="comment-reply ms-2">
                                  <button
                                    type="button"
                                    onClick={() => toggleReplyInput(child.id)}
                                  >
                                    reply
                                  </button>
                                </div>
                            ...
                            {visibleReplyInputs.includes(child.id) && (
                              <div className="inline-reply-input position-relative mt-1 mb-1">
                                <input
                                  ...
                                  onFocus={() => setFocusedCommentId(child.id)}
                      ...
                      {child.grandChild && child.grandChild.length > 0 && (
                        <div>
                                ...
                                <div className="single-comment-box-desc ps-1">
                                  <div className="single-comment-box-placeholder">
                                    ...
                                    <p className="mb-0">
                                      ...
                                      >
                                        @{grandchild.mentionUser || child.user}
                                      </Link>
                                      {grandchild.text}
                                    </p>
                                  </div>
                                  ...
                                  <div className="comment-action-wrapper">
                                    ...
                                    {grandchild.user !== currentUser && (
                                      <div className="comment-reply ms-2">
                                        <button
                                          type="button"
                                          onClick={() =>
                                            toggleReplyInput(grandchild.id)
                                          }
                                        >
                                          reply
                                        </button>
                                  ...
                                  {visibleReplyInputs.includes(
                                    ...
                                    <div className="inline-reply-input position-relative mt-1 mb-1">
                                      <input
                                        ...
                                        onFocus={() =>
                                          setFocusedCommentId(grandchild.id)
                                        }
                                        onBlur={() => setFocusedCommentId(null)}
                                        onKeyDown={(e) => {
                                          if (e.key === "Enter") {
